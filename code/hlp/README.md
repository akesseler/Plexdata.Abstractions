...
The help file project named ``Plexdata.AspNetCore.Http.help.shfbproj`` has been created using [Sandcastle Help File Builder](https://ewsoftware.github.io/SHFB/html/bd1ddb51-1c4f-434f-bb1a-ce2135d3a909.htm) version v2018.12.10.0.
...
* As first, you should create a copy of the help file project ``Plexdata.AspNetCore.Http.help.shfbproj`` and rename it, for instance into ``Plexdata.AspNetCore.Http.help-HTML.shfbproj``. 
...
After a successful build you will find the result inside the help project file’s sub-folder you named above.
